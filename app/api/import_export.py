...
def download_import_template():
    ...
    template_data = {
        ...
        '设备类别': ['铂热电阻', '玻璃量器'],
        '计量器具名称': ['铂热电阻温度计', '玻璃量筒'],
        '型号/规格': ['PT100', '500ml A级'],
        '准确度等级': ['A级', 'A级'],
        '测量范围': ['-200~850℃', '0~500ml'],
        '检定周期': ['1年', '2年'],
        '检定日期': ['2024-01-15', '2024-03-20'],
        '计量编号': ['PT001', 'GL001'],
        '安装地点': ['1号反应釜', '质检室'],
        '制造厂家': ['上海仪表厂', '北京玻璃厂'],
        '出厂日期': ['2023-12-01', '2023-11-15'],
        '检定方式': ['送检', '现场检定'],
        '设备状态': ['在用', '在用'],
        '备注': ['正常使用', '新购设备']
    }
    ...
    try:
        ...
        for index, row in df.iterrows():
            ...
            try:
                ...
                # 验证检定周期
                if str(row['检定周期']) not in ['1年', '2年']:
                    result["status"] = "失败"
                    result["message"] = "检定周期必须是'1年'或'2年'"
                    detailed_results.append(result)
                    error_count += 1
                    continue
